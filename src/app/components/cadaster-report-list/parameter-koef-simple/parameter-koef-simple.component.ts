        ...
        data.forEach((items) => {
          ...
          items.processes.forEach((process: any) => {
            Object.assign(process, {
              ...
              dicUnit: {
                id: process.dicUnitId,
                name: process.dicUnitName,
              },

              koefOperatingWeightUnit: {
                id: process.koefOperatingWeightUnitId,
                name: process.koefOperatingWeightUnitName,
              },

              koefLowerCalorificUnit: {
                id: process.koefLowerCalorificUnitId,
                name: process.koefLowerCalorificUnitName,
              },

              koefCaseBurningUnit: {
                id: process.koefCaseBurningUnitId,
                name: process.koefCaseBurningUnitName,
              },
              koefCo2Unit: {
                id: process.koefCo2UnitId,
                name: process.koefCo2UnitName,
              },
              koefCh4Unit: {
                id: process.koefCh4UnitId,
                name: process.koefCh4UnitName,
              },
              koefN2OUnit: {
                id: process.koefN2OUnitId,
                name: process.koefN2OUnitName,
              },
              koefPerfluorocarbonsUnit: {
                id: process.koefPerfluorocarbonsUnitId,
                name: process.koefPerfluorocarbonsUnitName,
              },
            });
          });
